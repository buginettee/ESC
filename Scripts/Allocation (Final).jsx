/** 
    ...
    * drawn object anchor points after ruler calibration is 0: bot left, 1: top left, 2: top right 3: bot right
    * user drawn anchor points is 0: bot right, 1: bot left, 2: top left, 3: top right
    */
...
function mergedInputs(myDoc){
    ...
    buttonSubmit.onClick = function (){
        ...
        if(scaleInputValue.text === null || fileNameInput.text === ''){
            ...
            if(!regexValueScale.test(scaleInputValue.text)){
                invalidIntegerInputError();
                output[0] = 0;
                }
            else {
...
function main(){
    ...
    while(1){
        ...
        //$.writeln("dataArray: " + dataArray[0][2].toSource());
        //$.writeln("dataArrayMixedSize: " + dataArray[0][2].length);
