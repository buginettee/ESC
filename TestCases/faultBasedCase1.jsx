...
function faultBasedTestAddToArrayStudents(array){  
   ...
   //CASE 1 - run this script with each boundary and you will see that the project can fit into boundary 2 but not 1, eventhough the boundaries are of the same total area. 
   //the way the boundaries are drawn matters
   var arrayLength = [80]
   var arrayWidth = [232]
   var length = 1;
