...
faultBasedTestAddToArrayStudents (array);
...
function faultBasedTestAddToArrayStudents(array){  
    
    var teamIDValue = 2020001;
    var prototype = ["software", "hardware"];
    
   // CASE 2 - run the script with ;ength in increasing order,decreasing order and random order, one at a time
   //when in increasing order/random order, not all the projects can get allocated because of the way the algorithm splits up the boundaries
   //sorting length in decreasing order ismost efficient way
   
   var arrayLength = [20,30,40,50,60,70,80,90,100,120];  // in increasing order
   //var arrayLength = [120,100,90,80,70,60,50,40,30,20];  // in decreasing order
   //var arrayLength = [30,20,50,80,120,100,90,70,60,40];  //in random order
